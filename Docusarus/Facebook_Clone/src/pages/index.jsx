...
export default function HomePage() {
  return (
    <>
      <h1 class="text-3xl font-bold underline text-center text-blue-500"></h1>
        ...
        <div className="left-input-container">
          <div>
            <div className="input-container">
              ...
              <a href="#" id="forgot-password-anchor">
                Forgot password?
              </a>
              <div className="create-account-container">
                <button id="create-button">Create New Account</button>
              </div>
            </div>
